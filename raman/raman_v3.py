...
class Raman:
    ...
    def _alpha_beta_molecular(self) -> None:
    ...
    def _alpha_elastic_aer(self) -> np.array:
        ...
        diff_num_desity, params = diff_chi_squared(num_density, self.z)

        ###

        plt.plot(params, self.z[2: len(self.z) - 3], "-")
        ...
        diff_ranged_corrected_signal = diff_chi_squared_2(range_corrected_signal, self.z, params)

        diff_num_signal = (diff_num_desity / num_density
                           - diff_ranged_corrected_signal / range_corrected_signal)
